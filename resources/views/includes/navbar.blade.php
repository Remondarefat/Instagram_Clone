...
<div class="offcanvas offcanvas-start show" tabindex="-4" id="offcanvas" aria-labelledby="offcanvasLabel">
    <div class="offcanvas-body d-flex flex-column p-4">
        ...
        <div class="d-flex gap-3 align-items-center px-2 py-3 mb-3 nav-tab nav-tab-home">
            <svg aria-label="Home"fill="currentColor" class="home-svg" height="24" role="img" viewBox="0 0 24 24"
                width="24">
                <title>Home</title>
                <path
        ...
        <div class="d-flex gap-3 align-items-center px-2 py-3 mb-3 nav-tab nav-tab-search">
            <svg aria-label="Search" fill="currentColor" class="search-svg" height="24" role="img"
                viewBox="0 0 24 24" width="24"> height="24" role="img" viewBox="0 0 24 24"
                width="24">
                <title>Search</title>
