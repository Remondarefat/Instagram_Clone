        ...
        <div class="modal-content">
            ...
            <div class="modal-body modal-height d-flex justify-content-center align-items-center flex-column" id="modalBody">
                ...
                <div class="d-flex justify-content-center align-items-center flex-column"  id="dragDropArea">
                    ...
                    <input id="file-upload" type="file" style="display: none;" onchange="displayImage(event)" multiple>
                </div>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="d-flex align-items-end">
                    <a id="shareButton" class="ms-5" >Share</a>
                    </div>
                </div>
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
                                <img id="croppedImagePrev" class="img-fluid" src="" alt="Cropped Image">
                            </div>
                            <div class="col-md-6">
                                ...
                                <form id="postForm">
                                    <div class="form-group">
                                        <textarea class="form-control post-caption" id="caption" rows="5" placeholder="Write a caption..."></textarea>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="hashtags" class="form-control hashtag" id="hashtag" placeholder="Hashtags">
                                    </div>  
                                </form>
                            </div>
                        </div>
