...
<div class="sidebar">
    <div class="d-flex flex-column p-2">
        ...
        <!-- Home Tab -->
        <div class="d-flex gap-3 align-items-center px-2 py-3 mb-3 nav-tab nav-tab-home">
        ...
        <div class="d-flex gap-3 align-items-center px-2 py-3 mb-3 nav-tab nav-tab-search">
            <svg aria-label="Search" fill="currentColor" class="search-svg" height="24" role="img"
                viewBox="0 0 24 24">
                <title>Search</title>
        ...
        <div class="d-flex gap-3 align-items-center px-2 py-3 mb-3 nav-tab nav-tab-profile">
            <img class="profile-img"  src="{{asset(str_replace('public/','storage/',Auth::user()->avatar))}}" alt="">
            <a class="text-decoration-none text-dark" href="/postprofile">Profile</a>
        </div>
        <!-- Settings Tab -->

        <div class="d-flex gap-3 align-items-center px-2 py-3 mb-3 nav-tab nav-tab-settings" id="settings-toggle">
            <svg aria-label="Settings" class="settings-svg" fill="currentColor" height="24" role="img"
                viewBox="0 0 24 24" width="24">
        ...
        <div id="settings-content" class="settings-content" style="display: none;">
            <ul class="list-unstyled d-flex flex-column">
                <li class="settings-list">
                    <svg aria-label="Settings" class="me-2" fill="currentColor" height="18" role="img"
